  ...
  return knex('choices').del()
    .then(function () {
      ...
      return knex('choices').insert([
        ...
        {scene_id: 3, choice_id: 7, text: 'Deflect with Humor: “Um, that variable should be renamed to Harrison?', points: 2, consequences: 'Everyone laughs, but Harrison’s eyes narrow. He’s on to your tricks, but what will the consequences be? 0 points'},
        {scene_id: 3, choice_id: 8, text: 'That’s a great question, and I’m glad you asked. Let’s use a collaborative problem solving paradigm to achieve our learning objectives - what does the room think?', points: 2, consequences: 'Everyone sees through your obvious attempt to cover your tracks. Lose 5 points.'},
        {scene_id: 3, choice_id: 9, text: 'I’m sorry, I’m not confident on this material, can you go back over it before I answer the question?', points: 2, consequences: 'A bunch of other people nod their heads and you can tell that they appreciate the chance to go over the material. Earn 5 points.'},
